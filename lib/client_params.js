...
/* "service" associated with buckets-mdapi DNS SRV records */
var dflClientCueballService = '_buckets_mdapi._tcp';
/* default TCP port for buckets-mdapi servers */
...
/*
 * This function takes the user-specified BucketsMdapiClient parameters, figures
 * out what kind of connection the user wants, and returns a description back to
 * the caller that includes the cueballOptions that will be used for creating a
 ...
 *                      "constructor", and "domain" are supplied by the
 *                      buckets-mdapi client and may not be specified here.
 *
 *       OR
 *
 ...
 */
function parseBucketsMdapiParameters(args) {
     ...
     */
    cueballopts.service = '_buckets_mdapi-bogus._tcp';
...
exports.parseBucketsMdapiParameters = parseBucketsMdapiParameters;
